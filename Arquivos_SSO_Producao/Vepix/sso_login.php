<?php
/**
 * Arquivo de Login SSO para o sistema: Vepix
    ...
    if(count($tokenParts) == 3) {
        ...
        if ($base64UrlSignature === $signature_provided) {
            ...
            if(time() <= $data->exp) {
                ...
                echo "<h1>Autenticado com Sucesso no Vepix!</h1>";
                echo "<p>Você está logado através do Hub Central.</p>";
                echo "<p><em>*Atenção programador: Altere este arquivo para redirecionar para o painel de admin real do Vepix (ex: header(\"Location: /admin\"))</em></p>";
                exit();
            } else {
